...
/**
 * Language strings for the quiz report aitext plugin.
 *
 * @package   quiz_aitext
...
$string['commentsummary'] = 'Comment Summary';
$string['coursename'] = 'Course name';
$string['defaultprompt'] = 'Summarise this text indicating what students have learnt and what they have not learnt';
$string['formathtml'] = ':and format with html tags:';
$string['no_attempts_found'] = 'No student submissions found for this quiz.';
$string['percentage'] = 'Percentage';
$string['pluginname'] = 'Report AI Text';
$string['prompt'] = 'Prompt';
$string['prompt_placeholder'] = 'Enter a custom prompt for the AI analysis...';
...
$string['totalsubmissions'] = 'Total student submissions found:';
